...
int main() try {
...

    {
        ...
        Buffer vbo(Buffer::Type::Vertex);
        Buffer ebo(Buffer::Type::Index);
        ...
        ebo.bind();
        glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indices)*sizeof(unsigned), indices.data(), GL_STATIC_DRAW);
//        vbo.copy(vertices);
//        vbo.copy(indices);
